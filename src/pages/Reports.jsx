  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {!['my-report', 'operations', 'imports', 'schedule'].includes(tab) && (
        <div data-tour="reports-date-presets" className="flex flex-wrap items-center gap-2 mb-4 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800">
      ...
      <div data-tour="reports-tabs" className="flex gap-0.5 mb-6 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl w-fit max-w-full overflow-x-auto no-scrollbar">
